...
if img_type_list.color_Doppler.select  % Color Doppler has been chosen
    ...
    img_type_list.directional_Doppler.image = construct_directional_image(sign * gather(M0_neg), sign * gather(M0_pos), is_low_frequency);
end

if img_type_list.color_Doppler.select % Directional Doppler has been chosen
    ...
    img_type_list.color_Doppler.image = construct_colored_image(sign * gather(freq_high), sign *gather(freq_low), is_low_frequency);
end
